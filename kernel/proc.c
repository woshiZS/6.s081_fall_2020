...
userinit(void)
{
  ...
  copypagetable(p->pagetable, p->kpgtbl, 0, PGSIZE);
  p->sz = PGSIZE;
...
fork(void)
{
  ...
  np->sz = p->sz;
  // copy np pagetable mapping to np kernel pagetable
  copypagetable(np->pagetable, np->kpgtbl, 0, np->sz);
